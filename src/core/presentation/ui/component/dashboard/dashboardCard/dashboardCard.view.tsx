    ...
    return (
        <>
            <div className='w-full mt-3'>
                <button className="w-full block max-w-sm p-6 bg-white bg-opacity-70 border border-gray rounded-lg shadow-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
