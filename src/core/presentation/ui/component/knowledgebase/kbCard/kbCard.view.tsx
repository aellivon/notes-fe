...
export const KnowledgebaseCardView: React.FC<IKnowledgebaseCardViewModel> = (props) => {
    ...
    return (
        ...
        <div className='w-full mt-3 p-3'>
            <a href="#" className="w-full max-h-96 h-96 block max-w-sm p-6 text-ellipsis overflow-hidden bg-green-100/40 bg-opacity-70 border border-gray rounded-lg shadow-lg hover:bg-green-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
